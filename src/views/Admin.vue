  ...
  <div class="adminbroni_all"> 
    <div class="bgr_adminbroni_cats"> 
        ...
        <div class="bgr_bronicats" v-for="item in cats" :key="item">
                <div class="photo_cat"><img class="photo_cat-img" :src="`http://26.48.41.80:8000/static/photos/${item.cat.photo_url}`" alt=""></div>
                <div class="data_broni">
                    <div class="all_bgr_imya">
                        <div class="bgr_imya"> 
                            <p class="p_imya"> Имя кошки </p>
                            <div class="bgr_imya_cat"> <p class="p_imya_cat"> {{ item.cat.name }} </p></div>
                        </div>
                    </div>

                    <div class="bgr_imya"> 
                            <p class="p_imya"> Имя клиента </p>
                            <div class="bgr_imya_cat"> <p class="p_imya_cat"> {{ item.user.first_name }} </p></div>
                    </div>
                    <div class="bgr_imya"> 
                            <p class="p_imya"> Номер телефона </p>
                            <div class="bgr_imya_cat"> <p class="p_imya_cat"> {{ item.user.phone_number }} </p></div>
                    </div>
                </div>
                <div class="button_krest"> <img src="../assets/imgs/krest.svg"  /> </div>
        </div>
    </div>
  </div>
</template>
