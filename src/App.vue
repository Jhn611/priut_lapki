...
<template>
  <header>
    <div class="background_find">
      ...
      <div class="header_text" v-if="$route.path !== '/admin_see_ad' || $route.path !== '/admin_list_priyuts' || $route.path !== '/admin_list_users' || $route.path !== '/admin_list_priyut_for_moderation' || $route.path !== '/admin_list_ad_for_moderation'">
